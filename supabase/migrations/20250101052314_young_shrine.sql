...
UNIQUE NULLS NOT DISTINCT (document_id, page_number);
...
DROP INDEX IF EXISTS idx_doc_info_lookup_v2;
DROP INDEX IF EXISTS idx_doc_info_status_date_v2;
DROP INDEX IF EXISTS idx_doc_info_composite_lookup;
DROP INDEX IF EXISTS idx_doc_info_status_tracking;

-- Create new optimized indices
CREATE INDEX idx_doc_info_lookup_v3 
ON document_info(document_id, page_number, processing_status);

CREATE INDEX idx_doc_info_status_v3 
