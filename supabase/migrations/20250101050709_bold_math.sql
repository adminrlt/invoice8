/*
  # Fix document info constraints and indices
...
DROP INDEX IF EXISTS idx_document_info_status_date;

-- Create new indices
CREATE INDEX idx_document_info_lookup 
ON document_info(document_id, page_number, processing_status);

CREATE INDEX idx_document_info_status_created 
